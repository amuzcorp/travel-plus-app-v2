...
const GnbHomeSelected = ({ color = '#E6E6E6', width = 39, height = 39, ...rest }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 39 39"
  ...
  >
    <path
      ...
      fill={color}
    />
    <path d="M6 17L20 5L33 16V34H24.5V24H16V34H6V17Z" fill={color} />
  </svg>
);

GnbHomeSelected.propTypes = {
  color: PropTypes.string,
  width: PropTypes.number,
  height: PropTypes.number,
};

export default GnbHomeSelected;
